// To parse this data:
//
//   import { Convert, IPeliculas } from "./file";
//
//   const iPeliculas = Convert.toIPeliculas(json);
//
...
export class Convert {
  public static toIPeliculas(json: string): IPeliculas {
      return cast(JSON.parse(json), r("IPeliculas"));
  }

  public static iPeliculasToJson(value: IPeliculas): string {
      return JSON.stringify(uncast(value, r("IPeliculas")), null, 2);
  }
}
