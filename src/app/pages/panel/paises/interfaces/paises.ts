...
export class Convert {
  public static toIPaises(json: string): IPaises {
      return cast(JSON.parse(json), r("IPaises"));
  }

  public static iPaisesToJson(value: IPaises): string {
      return JSON.stringify(uncast(value, r("IPaises")), null, 2);
  }
}
